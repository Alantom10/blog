function Card({ title, intro, coverImage, authorName, authorProfileImage, datePublished, layoutType }) {
    return (
        <>
            { layoutType === 'main' ? (
                <div className="flex rounded-md col-span-12 row-span-3 shadow-custom transition-shadow duration-700 transform hover:shadow-md hover:shadow-slate-950">
                ...
                <div className="flex flex-col rounded-md col-span-6 row-span-4 shadow-custom transition-shadow duration-700 transform hover:shadow-md hover:shadow-slate-950">
