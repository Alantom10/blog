        ...
        <footer className="w-full bg-react-blue flex flex-col px-10 pt-10 h-[40vh] justify-between">
            <div className="flex justify-between">
                <div>
                    ...
                    <div className="flex gap-2 md:transition-transform md:duration-300 md:flex md:flex-row">
                ...
                <div className="flex flex-col w-[450px] self-center">
            ...
            <p className="text-white text-sm pb-10 pt-6 self-center">© 2024 All Rights Reserved Alan Thomas</p>
        </footer>  
    );
};
